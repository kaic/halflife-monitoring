...
- The script copies `TempBridge.exe` to `%ProgramData%\TempBridge`, registers a Task Scheduler job that runs as **SYSTEM** at boot (highest privileges), and launches it hidden automatically
