...
- The script copies `TempBridge.exe` to `%ProgramData%\TempBridge`, registers a Task Scheduler entry (current user, highest privileges), and launches it hidden on every logon
