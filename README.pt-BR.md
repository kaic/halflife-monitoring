...
- O script copia o `TempBridge.exe` para `%ProgramData%\TempBridge`, cria uma tarefa no Agendador (executada como **SYSTEM**, com maiores privilégios) e garante que ele inicie oculto de forma automática
