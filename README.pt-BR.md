...
- O script copia o `TempBridge.exe` para `%ProgramData%\TempBridge`, cria uma tarefa no Agendador (executada com maiores privilégios) e garante que ele inicie oculto em todo logon
